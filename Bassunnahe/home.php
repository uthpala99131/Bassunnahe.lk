...
<header class="header">
  ...
  <nav class="navbar">
          ...
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">LOCATION</a>
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                      ...
                      <li><a class="dropdown-item" href="#">mathara</a></li>
                      <li><a class="dropdown-item" href="#">kaluthara</a></li>
                      <li><a class="dropdown-item" href="#">matale</a></li>
  ...
  <form action="loghome.html" class="login-form" method="POST">
    <h3>LOGIN</h3>
    <input type="email" name="email" placeholder="Your email" class="box" required>
    <input type="password" name="password" placeholder="Your password" class="box" required>
    <p class="F">Forgot your password? <a href="#">Click here</a></p>
    <p>Don't have an account? <a href="register.php">Register now</a></p>
    
    <button  type="submit" value="Login now" class="btn">LOGIN</button>
            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
              ...
              <div class="carousel-inner">
                  ...
                  <div class="carousel-item">
                    <img src="imagess/background/2.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption  d-md-block">
                      <h3>Start your Day <br>Find your better Choice</h3>
                      <p>
  ...
  <div class="container-fluid">
    ...
    <div class="ratings">
      ...
      <button class="rate-btn">ADD RATINGS</button>
                      ...
                      <div class="row">
                        <div class="col-md-4 py-3 py-md-0">
                          <div class="card">
                            ...
                            <div class="card-body">
                              <h3>How to register the website?</h3>
                              <h5>admin  16 may 2024</h5>
                              <p></p>
                              <a href="https://nibm-my.sharepoint.com/:v:/g/personal/kadbis231f-020_student_nibm_lk/EShEGMrmAsZCsO6-JhNMANYBr5utK8d8NXmBpe1JezK33g?e=6kbcgO">
                        ...
                        <div class="col-md-4 py-3 py-md-0">
                          <div class="card">
                            ...
                            <div class="card-body">
                              <h3>How to hire to labor?</h3>
                              <h5>admin  6 may 2024</h5>
                              <p></p>
                              <a href="https://nibm-my.sharepoint.com/:v:/g/personal/kadbis231f-020_student_nibm_lk/ESZETM0li2tMu5H57wY9bgYB6XEsPhupil7UoPi-Sseimg?e=vnM6BH">
                              <button id="blog-btn">Read more...</button>
                              </a>
                            </div>
                          </div>
                        ...
                        <div class="col-md-4 py-3 py-md-0">
                          <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              <h5>admin  4 may 2024</h5>
                              <p></p>
                              <a href="https://nibm-my.sharepoint.com/:v:/g/personal/kadbis231f-020_student_nibm_lk/Ecixcrb2y7tKmsrKYC-0ki0BZD7i3C1DfQ5FUfMzmx_kOw?e=a89Sh6">
                              <button id="blog-btn">Read more...</button>
                              </a>
                            </div>
                          </div>
          ...
          <section id="contact">
            ...
            <form method="post" action="home.php">
                ...
                <div class="col-md-5" id="col">
                  ...
                  <p><i class="fa-solid fa-phone"></i> - 0813216549</p>
        ...
        <?php    
          include_once 'DBconnection.php';if ($conn->connect_error) {
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "INSERT INTO contact_messages (name, email, phone, description) VALUES ('$name', '$email', '$phone', '$description')";
